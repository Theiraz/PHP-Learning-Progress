...
<?php 
    ...
    */
    ...
    // Here ends the Basic Arithmetic ------------------------------------------------------------------------------------------------------------------------------------------
?>
...
<!--- <!DOCTYPE html> ----------------------------------------------------------------- Whole section (HTML + PHP) Is surrounded in two comments to keep it clean.
<html lang="en">
<head>
    <meta charset="UTF-8">
...
*/   
// ----------------------------------------------------------------------------------------------------------------------------------- Whole $_GET , $_POST and HTML Doctype is surrounded in a comment to not get overcrowded.
?>


<!--- <!DOCTYPE html> ------------------------------------------------------------------------------------ Pizza Order and changes between $_GET and $_POST differences.
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
...
<?php  
    ...
    echo "Your total is: \${$total}<br>"; 
    */
    // --------------------------------------------------------------------------------------------------------------Here ends the whole $_GET and $_POST excercise + section.
?>
...
<?php /*
     ...
     */ 
    //  -------------------------------------------- Here Ends Math Related Functions in PHP excercise 
?> 
